...
const { TezCoinConnector, RewardRulesConnector } = require("../utils/TezCoin");
...
const getAmount = async (req, res) => {
    try {
        ...
        const tezCoin = await TezCoinConnector();
        // console.log(tezCoin.symbol());

        let addrBalance;
        try {
            addrBalance = await tezCoin.balanceOf(useraddress);
        } catch (balanceErr) {
