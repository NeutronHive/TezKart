...
exports.TezCoinConnector = async () => {
    try {
        const [owner] = await ethers.getSigners();

        const tezCoinAddress = "0x07Cb1D16A5697332a489192071AEb9b247BaA5aA"; 
        ...
        const TezCoin = new ethers.Contract(tezCoinAddress, abi, owner);      
        return TezCoin;
    } catch (error) {
        console.log('Error initializing TezCoin contract:');
...
exports.RewardRulesConnector=async() => {
    ...
    const rewardRulesAddress = "0x7AcC37BaA9FC3E447833700BD2Bc4A5536117C4f"; 
