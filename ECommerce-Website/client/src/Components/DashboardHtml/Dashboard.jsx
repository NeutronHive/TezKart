...
const Dashboard = () => {
  ...
  const [TezCoins, setTezCoins] = useState(0);
  const [transactions, setTransactions] = useState([]);
  const [graphdata, setGraphdata] = useState([0,100,90]);

  const getTezCoins = async () => {
    // console.log(account._id)
    const res = await axios.post(
      `${process.env.REACT_APP_BASE_URL}/getTezCoins`,
      {
        userId: account._id,
      }
    );
    console.log(res.data);
    setTezCoins(res.data.balance);
  };
  ...
  return (
    ...
    <div class="flex">
      ...
      <section class="section__main">
        ...
        <div class="bg-primary flex flex-justify-between flex-align-center banner" style={{backgroundColor:"#222"}}>
          <div>
            <h1 class="text-5xl text-white mb-2">
              Hello <span style={{ color: "#e25ae1" }}>{account.firstname}</span>,
            </h1>
            <h1 class="text-3xl text-white mb-2">Manage your</h1>
            <h1 class="text-3xl text-white mb-4">TezCoin Portfolio</h1>
          </div>
          <div
            class="banner__img"
            style={{ marginRight: "-5rem", marginTop: "1.5rem" }}
          >
            <img src="./TezCoin.png" height={320} alt="banner" />
          </div>
        </div>
        <h2 class="text-2xl mb-5" style={{color:"#222"}}>
          My Portfolio{" "}
          <Tooltip title="Copy Wallet Address">
            <Button onClick={handleCopy}>
              <CopyAllOutlined style={{color:"#222"}} />
            </Button>
          </Tooltip>{" "}
        </h2>
        <div class="portos">
          <div class="flex flex-justify-begin flex-align-center bg-white porto">
            ...
            <div class="mt-1">
              ...
              <div class="flex flex-align-center flex-justify-between">
                <small class="text-gray-500">TezCoins</small>
      ...
      <section class="section__account">
        ...
        <h2 class="text-2xl mb-4" style={{color:"#222"}}>Accounts</h2>
        <div class="card flex flex-align-center flex-justify-center flex-column mb-4" style={{backgroundColor:"#222"}}>
          <img src="./gem.png" height={50} alt="" />
          <h2 class="text-2xl text-white text-bold mt-2 mb-2">{TezCoins} TZC</h2>
          <p class="text-bold text-white flex flex-align-center" style={{backgroundColor:"#fff",color:"#045527"}}>
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
        ...
        <div class="flex flex-align-center flex-justify-between mb-8 " >
          <Link to="/coupons" style={{ textDecoration: "none" }}>
            <button
              ...
              style={{ cursor: "pointer", width: "277px",backgroundColor:"#222"}}
            >
        ...
        {isloading ? (
          ...
          <h2 class="text-2xl mt-6 mb-4" style={{color:"#222"}}>Recent Transactions</h2>
        ) : (
          <div>
            {" "}
            ...
            <div class="transaction flex flex-align-center flex-justify-between mb-4">
              <div class="flex flex-align-center flex-justify-between">
                ...
                <div style={{ fontSize: "1rem" }}>
                  {transaction.to === account.walletAddress ? (
                    <p class="text-bold">
                      TezCoins <br /> Rewarded
                    </p>
                  ) : (
                    <p class="text-bold">
                      TezCoins <br /> Deducted
                    </p>
                  )}
