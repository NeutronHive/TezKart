      ...
      <ul>
        <li>
          ...
          <p>
            ...
            <br />• The name of our token is TezCoin
            <br />• TezCoin carries it's symbol as TZC
            <br />• TezCoin is a fungible token
            <br />• TezCoins can be earned by users through various actions -
            Shopping, social media interaction, etc..
            <br />• TezCoin has real market value and can be earned from our
            partners as well
            <br />• TezCoins can be spent to buy various coupons on flipKart and
            from our partners
            <br />• TezCoin has a decaying period of 30 days
          </p>
        </li>
        <li>
          <input
          ...
          <p>
            Users can earn TezCoinss by performing specific actions as outlined
        ...
        <li>
          ...
          <p>
            ...
            implemented a decaying nature for TezCoins. After a period of 30
